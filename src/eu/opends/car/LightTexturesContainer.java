...
public class LightTexturesContainer
{
	...
	public enum LightState
	{
		...
		LeftTurnBrakeLights, RightTurnBrakeLights, HazardLightsBrakeLights, EmergencyLights;
	}
	
	
	public enum TurnSignalState
	{
		LEFT, RIGHT, BOTH, OFF, EMER;
	}
	...
	public void setEmergencyLight(boolean setToOn){

		if (setToOn)
			setLightState(LightState.EmergencyLights);
		else 
			setLightState(LightState.AllOff);
