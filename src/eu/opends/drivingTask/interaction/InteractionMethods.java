...
//import eu.opends.trigger.HighlightAndMakeScreenshot;
import eu.opends.trigger.JakartaTask2;
import eu.opends.trigger.JakartaTask4;
...
import eu.opends.trigger.SetMaxSpeed;
...
import eu.opends.trigger.JakartaTask5;
import eu.opends.trigger.JakartaTask8;
import eu.opends.trigger.JakartaTask9StartMonitoring;
import eu.opends.trigger.JakartaTask9StopMonitoring;
import eu.opends.main.Simulator;
...
/*	@Action(
			name = "highlightAndMakeScreenhot", 
			layer = Layer.SCENE, 
			description = "Manipulates visibility of the given model",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="id", type="String", defaultValue="model01", 
								description="ID of the model to be made visible"),
					 @Parameter(name="visible", type="Boolean", defaultValue="true", 
								description="Makes the model (in)visible")
					}
		)
	public TriggerAction highlightAndMakeScreenhot(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "";
		...
		try {
			...
			// create HighlightAndMakeScreenshot
			HighlightAndMakeScreenshot highlightAndMakeScreenshot = 
				new HighlightAndMakeScreenshot((Simulator) sim, delay, repeat, id);

			// set visibility, if available
			parameter = "visible";
			String visible = parameterList.getProperty(parameter);
			if(visible != null)
				highlightAndMakeScreenshot.setVisibility(Boolean.parseBoolean(visible));
			
			return highlightAndMakeScreenshot;
			...
			reportError("highlightAndMakeScreenshot", parameter);
			return null;
		}
	}
	*/
	@Action(
			name = "jakartaTask5", 
			layer = Layer.SCENE, 
			description = "Helps with jakarta task 5 scoring",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="id", type="String", defaultValue="model01", 
								description="ID of the model to be made visible"),
	...
	public TriggerAction jakartaTask5(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "";
		...
		try {
			...
			// create HighlightAndMakeScreenshot
			JakartaTask5 jakartaTask5 = 
				new JakartaTask5((Simulator) sim, delay, repeat, id);
			...
			reportError("jakartaTask5", parameter);
			return null;
		}
	}
	...
	@Action(
			name = "jakartaTask2", 
			layer = Layer.SCENE, 
			description = "Helps with jakarta task 2 scoring",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="id", type="String", defaultValue="model01", 
								description="ID of the model to be made visible"),
	...
	public TriggerAction jakartaTask2(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "";
		...
		try {
			...
			// create HighlightAndMakeScreenshot
			JakartaTask2 jakartaTask2 = 
				new JakartaTask2((Simulator) sim, delay, repeat, id);
			...
			reportError("jakartaTask2", parameter);
			return null;
		}
	}
	...
	@Action(
			name = "jakartaTask4", 
			layer = Layer.SCENE, 
			description = "Helps with jakarta task 4 scoring",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="id", type="String", defaultValue="model01", 
								description="ID of the model to be made visible"),
	...
	public TriggerAction jakartaTask4(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "";
		...
		try {
			...
			// create HighlightAndMakeScreenshot
			JakartaTask4 jakartaTask4 = 
				new JakartaTask4((Simulator) sim, delay, repeat, id);
			...
			reportError("jakartaTask4", parameter);
			return null;
		}
	}
	...
	@Action(
			name = "jakartaTask8", 
			layer = Layer.SCENE, 
			description = "Helps with jakarta task 8 scoring",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="id", type="String", defaultValue="model01", 
								description="ID of the model to be made visible"),
	...
	public TriggerAction jakartaTask8(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "";
		...
		try {
			...
			// create HighlightAndMakeScreenshot
			JakartaTask8 jakartaTask8 = 
				new JakartaTask8((Simulator) sim, delay, repeat, id);
			...
			reportError("jakartaTask8", parameter);
			return null;
		}
	}
	...
	@Action(
			name = "jakartaTask9StartMonitoring", 
			layer = Layer.INTERACTION, 
			description = "Start monitoring leadman",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="isEnabled", type="Boolean", defaultValue="1", 
							 	description="Starts/stopps lead man monitoring")
					}
		)
	public TriggerAction jakartaTask9StartMonitoring(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "isEnabled";
		
		try {
			
			// read whether leadman will be switched on or off
			String leadmanString = parameterList.getProperty(parameter);
			if(leadmanString == null)
				leadmanString = setDefault("jakartaTask9", parameter, "false");
			boolean leadmanOn = Boolean.parseBoolean(leadmanString);
			
			// create SetAutoPilotTriggerAction
			JakartaTask9StartMonitoring jakartaTask9StartMonitoring = new JakartaTask9StartMonitoring(delay, repeat, (Simulator) sim, leadmanOn);
			return jakartaTask9StartMonitoring;
					
		} catch (Exception e) {
	
			reportError("jakartaTask9", parameter);
			return null;
		}
	}
	
	@Action(
			name = "jakartaTask9StopMonitoring", 
			layer = Layer.INTERACTION, 
			description = "Stop monitoring leadman",
			defaultDelay = 0,
			defaultRepeat = 0,
			param = {@Parameter(name="isEnabled", type="Boolean", defaultValue="1", 
							 	description="Stopp lead man monitoring")
					}
		)
	public TriggerAction jakartaTask9StopMonitoring(SimulationBasics sim, float delay, int repeat, Properties parameterList)
	{
		String parameter = "isEnabled";
		...
		try {
			...
			// create SetAutoPilotTriggerAction
			JakartaTask9StopMonitoring jakartaTask9StopMonitoring = new JakartaTask9StopMonitoring(delay, repeat, (Simulator) sim, leadmanOn);
			return jakartaTask9StopMonitoring;
