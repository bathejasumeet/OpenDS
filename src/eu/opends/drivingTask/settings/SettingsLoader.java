...
public class SettingsLoader
{
	...
	public enum Setting
	{
		...
		General_ScreenshotPath("settings:general/settings:screenshotPath"),
		General_radarCamera_enabled("settings:general/settings:radarCamera/settings:enable"),
		...
		Joystick_enableSpringForce("settings:controllers/settings:joystick/settings:springForce/@enabled"),
		Joystick_springForce("settings:controllers/settings:joystick/settings:springForce/@force"),
		Joystick_enableDamperForce("settings:controllers/settings:joystick/settings:damperForce/@enabled"),
		Joystick_damperForce("settings:controllers/settings:joystick/settings:damperForce/@force"),
		Joystick_enableSineForce("settings:controllers/settings:joystick/settings:sineForce/@enabled"),
		Joystick_sineForce("settings:controllers/settings:joystick/settings:sineForce/@force"),
		Joystick_enableSquareForce("settings:controllers/settings:joystick/settings:squareForce/@enabled"),
		Joystick_squareForce("settings:controllers/settings:joystick/settings:squareForce/@force"),
