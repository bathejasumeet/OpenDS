...
public class SceneLoader 
{
	...
	private String steeringWheel_left;
	private String steeringWheel_right;
	private String wheelFrontLeft;
	private String wheelFrontRight;
	private String wheelBackLeft;
	private String wheelBackRight;
	private String instrumentCluster_left;
	private String instrumentCluster_right;
	private String whipersLeft_left;
	private String whipersRight_left;
	private String whipersLeft_right;
	private String whipersRight_right;
	private String windshield_left;
	private String windshield_right;
	...
	public String getSteeringWheelLeft(){
		return steeringWheel_left;
	}
	
	public String getSteeringWheelRight(){
		return steeringWheel_right;
	}
	...
	public String getInstrumnetClusterLeft(){
		return instrumentCluster_left;
	}
	
	public String getInstrumnetClusterRight(){
		return instrumentCluster_right;
	}
	
	public String getWhipersLeftLeft(){
		return whipersLeft_left;
	}
	
	public String getWhipersRightLeft(){
		return whipersRight_left;
	}

	public String getWhipersLeftRight(){
		return whipersLeft_right;
	}
	
	public String getWhipersRightRight(){
		return whipersRight_right;
	}
	
	public String getWindschieldLeft(){
		return windshield_left;
	}
	
	public String getWindschieldRight(){
		return windshield_right;
	}
	...
	{	
		...
		try {
			...
			for (int k = 1; k <= modelNodes.getLength(); k++) 
			{
				...
				//System.out.println("Node " + currentNode.getBaseURI());
				// get name
				...
				try {
					...
					if (name.equals("shadowSteeringWheel_left"))
						steeringWheel_left = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowSteeringWheel_right"))
						steeringWheel_right = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowInstrumentCluster_left"))
						instrumentCluster_left = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowInstrumentCluster_right"))
						instrumentCluster_right = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					...
					if (name.equals("shadowWhipersLeft_left"))
						whipersLeft_left = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowWhipersRight_left"))
						whipersRight_left = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowWhipersLeft_right"))
						whipersLeft_right = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowWhipersRight_right"))
						whipersRight_right = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					
					
					if (name.equals("shadowGlassRainLayer_left"))
						windshield_left = currentNode.getAttributes().getNamedItem("key").getNodeValue();
					
					if (name.equals("shadowGlassRainLayer_right"))
						windshield_right = currentNode.getAttributes().getNamedItem("key").getNodeValue();
