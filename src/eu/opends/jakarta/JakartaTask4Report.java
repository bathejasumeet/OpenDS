...
public class JakartaTask4Report {
	private String dataFileName = "JakartaTask4ReportData.xml";
	private String reportFileName = "JakartaTask4Report.pdf";
	private String outputFolder;
	BufferedWriter bw;

	public void generateReport(String driverName, boolean rollback, boolean score) {
		try {
			...
			bw.write("\t<rollback>" + rollback + "</rollback>\n");
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask4Template.jrxml");
