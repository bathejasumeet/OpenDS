...
public class JakartaTask5Report {
	private String dataFileName = "JakartaTask5ReportData.xml";
	private String reportFileName = "JakartaTask5Report.pdf";
	private String outputFolder;
	BufferedWriter bw;

	public void generateReport(String driverName, boolean within20cm, boolean moreThan20cm, boolean destination,
			boolean collisionWithCones, boolean idealLine, int score) {
		try {
			...
			bw.write("\t<within20cm>" + within20cm + "</within20cm>\n");
			bw.write("\t<moreThan20cm>" + moreThan20cm + "</moreThan20cm>\n");
			bw.write("\t<destination>" + destination + "</destination>\n");
			bw.write("\t<collisionWithCones>" + collisionWithCones + "</collisionWithCones>\n");
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask5Template.jrxml");
