...
public class JakartaTask7Report {
	private String dataFileName = "JakartaTask7ReportData.xml";
	private String reportFileName = "JakartaTask7Report.pdf";
	private String outputFolder;
	BufferedWriter bw;

	public void generateReport(String driverName, int score) {
		try {
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask7Template.jrxml");
