...
public class JakartaTask3Report {
	private String dataFileName = "JakartaTask3ReportData.xml";
	private String reportFileName = "JakartaTask3Report.pdf";
	private String outputFolder;
	BufferedWriter bw;

	public void generateReport(String driverName, int numberOfTurns, int score) {
		try {
			...
			bw.write("\t<numberOfTurns>" + numberOfTurns + "</numberOfTurns>\n");
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask3Template.jrxml");
