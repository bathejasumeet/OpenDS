...
public class JakartaTask6Report {
	private String dataFileName = "JakartaTask6ReportData.xml";
	private String reportFileName = "JakartaTask6Report.pdf";
	...
	public void generateReport(String driverName, boolean score) {
		try {
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask6Template.jrxml");
