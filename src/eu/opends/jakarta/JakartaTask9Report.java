...
public class JakartaTask9Report {
	private String dataFileName = "JakartaTask9ReportData.xml";
	private String reportFileName = "JakartaTask9Report.pdf";
	private String outputFolder;
	BufferedWriter bw;

	public void generateReport(String driverName, boolean score) {
		try {
			...
			InputStream inputStream = new FileInputStream("assets/JasperReports/templates/JakartaTask9Template.jrxml");
