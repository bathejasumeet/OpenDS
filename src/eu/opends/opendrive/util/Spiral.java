...
public class Spiral
{
	...
	/* S(x) for small x */
	private static double[] sn = new double[]{
	...
	private static double[] sd = new double[]{
	...
	/* C(x) for small x */
	private static double[] cn = new double[]{
	...
	private static double[] cd = new double[]{
	...
	private static double[] fn = new double[]{
	...
	private static double[] fd = new double[]{
	/*  1.00000000000000000000E0,*/
	...
	private static double[] gn = new double[]{
	...
	private static double[] gd = new double[]{
	/*  1.00000000000000000000E0,*/
	...
	private static Vector3d fresnel(double xxa)
	{
	...
	* @param z      resulting z-coordinate in spirals local co-ordinate system [m]
	* @param t      tangent direction at s [rad]
	*/

	public static CurvePoint odrSpiral( double s, double cDot)
	{
	    double a;
	    ...
	    double t = s * s * cDot * 0.5;
	    
	    return new CurvePoint(vec, t);
	}
	
	/*
	public static void main(String[] args)
	{	    
	    System.out.println("#  OpenDRIVE spiral example" );
	    System.out.println("#  ------------------------\n#" );
	    System.out.println("#  Computing a spiral with" );
	    System.out.println("#    initial curvature =   0.000 1/m" );
	    System.out.println("#    length            = 300.000 m" );
	    System.out.println("#    curvDot           =   0.001 1/m2\n#" );
	    
	    for (double s = 0.0; s < 300.0; s += 1.0 )
	    {
	        CurvePoint tp = odrSpiral(s, 0.001);
	        Vector3d vec = tp.getCoordinates();
	        System.out.println(vec.x + " - " + vec.z + " - " + tp.getOrtho());
	    }
