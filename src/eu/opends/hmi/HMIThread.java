...
public class HMIThread extends Thread
{
	...
	public void run() 
	{
		...
		System.out.println("Start of message on HMI unit = "+start);
		...
		if(presentationID >= 0)
		{
			...
			//System.out.println("End of message on HMI unit =" + end);
			presentationModel.stop();
			System.out.println("Duration of message on HMI unit was (in seconds) = "+(end-start)/1000);
