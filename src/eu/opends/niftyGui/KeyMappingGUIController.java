...
//		
//		if (current != null)
//			System.out.println("Screen obtained");
//			Element results = nifty.getCurrentScreen().findElementById(elementID);
//		return results;
    	//return nifty.getCurrentScreen().findElementById(elementID);
    	
    	System.out.println("Current screen is " + nifty.getCurrentScreen().getScreenId());
    	return nifty.getScreen("start").findElementByName(elementID);
    }
