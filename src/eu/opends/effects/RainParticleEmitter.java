...
public class RainParticleEmitter extends ParticleEmitter
{
	...
	public RainParticleEmitter(AssetManager assetManager, float percentage, ColorRGBA color)
	{
	...
	private void setupMaterial() 
	{
		...
		this.setLowLife(1f);
		this.setHighLife(2f);
		this.getParticleInfluencer().setInitialVelocity(new Vector3f(0, -10, 0));
		this.getParticleInfluencer().setVelocityVariation(0f);
		this.setShape(new EmitterBoxShape(new Vector3f(-50f,1.5f,-20f),new Vector3f(50f,14.5f,50f)));
	}
