...
public class KeyMapping
{
	...
	//public static KeyMapping TOGGLE_KEYMAPPING = new KeyMapping("turn_whipers", "turn on/off whipers", new String[] {"KEY_F1"});
	...
	public static KeyMapping RESET_CAR_POS2 = new KeyMapping("reset_car_pos2", "reset car (pos 2)", new String[] {"KEY_NUMPAD2"});
	public static KeyMapping RESET_CAR_POS3 = new KeyMapping("reset_car_pos3", "reset car (pos 3)", new String[] {"KEY_NUMPAD3"});
	public static KeyMapping RESET_CAR_POS4 = new KeyMapping("reset_car_pos4", "reset car (pos 4)", new String[] {"KEY_NUMPAD4"});
	public static KeyMapping RESET_CAR_POS5 = new KeyMapping("reset_car_pos5", "reset car (pos 5)", new String[] {"KEY_NUMPAD5"});
	public static KeyMapping RESET_CAR_POS6 = new KeyMapping("reset_car_pos6", "reset car (pos 6)", new String[] {"KEY_NUMPAD6"});
	public static KeyMapping RESET_CAR_POS7 = new KeyMapping("reset_car_pos7", "reset car (pos 7)", new String[] {"KEY_NUMPAD7"});
	public static KeyMapping RESET_CAR_POS8 = new KeyMapping("reset_car_pos8", "reset car (pos 8)", new String[] {"KEY_NUMPAD8"});
	public static KeyMapping RESET_CAR_POS9 = new KeyMapping("reset_car_pos9", "reset car (pos 9)", new String[] {"KEY_NUMPAD9"});
	public static KeyMapping RESET_CAR_POS10 = new KeyMapping("reset_car_pos10", "reset car (pos 10)", new String[] {"KEY_NUMPAD0"});
